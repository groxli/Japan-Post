...
$extractHandle = fopen("../extracts/unique_glyphs.csv", "a");
...
$results = mysql_query('SELECT count(*) AS theCount, glyph FROM address_glyph GROUP BY glyph ORDER BY theCount DESC');
while ($row = mysql_fetch_assoc($results)) {
  $outStr = $row['theCount'] . "," . $row['glyph'] . "\n";
